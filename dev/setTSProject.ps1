...
Function Create-Project() {
    [CmdletBinding()]
    Param(
        [Parameter(Mandatory=$True, ParameterSetName="TypeScript", HelpMessage="Type a framework, you want to create a project for.")]
        [String]$ProjectType
    )
...
Function Create-React {
    Write-Host "React project creation under development..." -ForegroundColor Yellow
}
